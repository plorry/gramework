 ...
 *
 */
var Camera = exports.Camera = function(sceneExtents, options) {
...
Camera.prototype.draw = function(surface) {
    this.view.blit(surface, [0,0], this.rect);
    return this.view;
};
...
// Follow a rect body.
Camera.prototype.follow = function(rect) {
    this.center = rect;
    return;
};
