var Box2D = require('box2dweb');
  ...
  var Physics = exports.Physics = function(options) {
    options = (options || {});

    var gravity = new b2Vec2(0, (options.gravity || 9.8));
  ...
  Physics.prototype.draw = function(surface) {
      if (this.debugDraw) {
